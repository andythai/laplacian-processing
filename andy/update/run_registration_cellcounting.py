...
def antsRegistration(fixedImagePath, movingImagePath, outputDir, rescale=True):
    """
...
def antsTransformation(imagePath, regDir, outDir=None):
    """
...
def registration(fixedImagePath, movingImagePath, outputDir):
    ...
    antsResult = antsRegistration(fixedImagePath, movingImagePath, outputDir, rescale=True)
    antsResult = antsTransformation(axisAlignedDataPath, outputDir)
    movingImagePath = antsResult
    ...
    refinedResultPath = os.path.join(outputDir, "antsRefined.nii.gz")
